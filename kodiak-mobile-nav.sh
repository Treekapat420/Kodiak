...
echo "🐻 Adding Kodiak mobile navigation..."
...
git commit -m "add mobile navigation with dashboard link" || true

echo ""
echo "✅ Mobile navigation added."
echo "Refresh Kodiak. Dashboard will now appear under the header."
